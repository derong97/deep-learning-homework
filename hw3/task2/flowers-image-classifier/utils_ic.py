...
# Define function to plot loss-step graph
def plot_loss_step_graph(train_loss_hist, val_loss_hist):
    ''' Plots the loss-step graph
    '''
    steps = len(train_loss_hist)
    plt.plot(range(steps), train_loss_hist, 'g', label='Training loss')
    plt.plot(range(steps), val_loss_hist, 'b', label='Val loss')
